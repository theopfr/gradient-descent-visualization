...
def train(dataset, epochs=10, lr=0.01):
    ...
    # initializing thetas to start at the highest loss (uncomment below, comment above)
    theta_0 = -1                                                        # y-intercept
    theta_1 = -1                                                        # slope

    # or initializing random theta starting values
    ...
    plot_loss_surface(xs, ys, zs, point=(theta_1, theta_0, loss))
